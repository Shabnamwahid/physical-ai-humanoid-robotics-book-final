...
actual_duration: 2
completion_criteria:
  - Generate complete content for all chapter 2 sections
...
# Generate Content for Chapter 2

## Objective

Analyze the folder docs/chapter-2-basics-of-humanoid-robotics.
Generate complete textual content for each section (2.1 to 2.6) using Chapter 1 as the structural template.
...
After generating content, update history/prompts automatically without changing any existing files outside the chapter-2 folder.
Keep track of which sections were previously empty and now filled.
Do not overwrite other chapters or appendices.

## Requirements

- Generate complete content for sections 2.1 through 2.6
...
- Do not modify files outside chapter-2 folder

## Files Affected

- docs/chapter-2-basics-of-humanoid-robotics/2.1-anatomy.md
- docs/chapter-2-basics-of-humanoid-robotics/2.2-biomechanics.md
- docs/chapter-2-basics-of-humanoid-robotics/2.3-balance-locomotion.md
- docs/chapter-2-basics-of-humanoid-robotics/2.4-actuator-technologies.md
- docs/chapter-2-basics-of-humanoid-robotics/2.5-safety-considerations.md
- docs/chapter-2-basics-of-humanoid-robotics/2.6-platforms-overview.md
- docs/chapter-2-basics-of-humanoid-robotics/index.md

## Constraints

- Maintain consistency with Chapter 1 template structure
- Do not change files outside the chapter-2 folder
- Preserve existing index and navigation structure
- Use appropriate technical language for humanoid robotics textbook

## Success Criteria

- All sections 2.1-2.6 contain complete, educational content
